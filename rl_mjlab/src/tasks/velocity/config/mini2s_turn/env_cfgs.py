"""Mini2S flat-terrain recovery (turn-over) environment configuration."""

import math

from src.assets.robots import get_mini2s_turn_robot_cfg
...
def mini2s_flat_turn_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create Mini2S flat terrain recovery configuration."""
  ...
  cfg.scene.entities = {
    "robot": with_delayed_articulation(get_mini2s_turn_robot_cfg(), play=play),
  }
  ...
  allowed_ground_geom_names = calf_geom_names 
